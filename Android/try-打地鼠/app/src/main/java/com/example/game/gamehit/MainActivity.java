...
//        playBackgroundVoide();
	...
	public void nextLevel(){
		...
		imgView.setBackgroundColor(getResources().getColor(R.color.frameColor));
		imgView.setBackgroundResource(R.drawable.nextlevel);
		Builder nextLevel = new Builder(mContext);
		nextLevel.setView(imgView);
		//结束
...
//			Const.backgroundImgResid = R.drawable.maplevel48_001;
			Const.backgroundImgResid = R.drawable.playbackground;
