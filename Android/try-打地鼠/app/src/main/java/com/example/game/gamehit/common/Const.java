 ...
 */
package com.example.game.gamehit.common;
...
public class Const {
	...
	public static final int setting=2;//new
	...
	/*
	 * soundIds[0] = mSoundPool.load(mContext, R.raw.shoot, 1);
		soundIds[1] = mSoundPool.load(mContext, R.raw.hit, 1);
		soundIds[2] = mSoundPool.load(mContext, R.raw.no, 1);
		soundIds[3] = mSoundPool.load(mContext, R.raw.nextlevel, 1);
		soundIds[4] = mSoundPool.load(mContext, R.raw.gameover, 1);
	 */
